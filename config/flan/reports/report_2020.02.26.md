Flan Scan ran a network vulnerability scan with the following Nmap command on Wed Feb 26 21:53:03 2020 UTC.
```
...
### axhttpd/1.4.9 
 - `192.168.0.11:443`
### OpenSSH 7.6p1 Ubuntu 4ubuntu0.3 (cpe:/a:openbsd:openssh:7.6p1) (cpe:/o:linux:linux_kernel) 
 - `192.168.0.52:22`
...
### lighttpd (cpe:/a:lighttpd:lighttpd) 
 - `192.168.0.1:80`
 - `192.168.0.1:443`
### Amazon Whisperplay DIAL REST service (cpe:/a:amazon:whisperplay) 
 - `192.168.0.14:8009`
### http 
 - `192.168.0.10:80`
...
### Nmap output
```
# Nmap 7.80 scan initiated Wed Feb 26 21:53:03 2020 as: nmap -sV -oX /shared/xml_files/2020.02.26/192.168.0.1-24.xml -oN - -v1 --script=vulners/vulners.nse 192.168.0.1/24
...
Increasing send delay for 192.168.0.51 from 0 to 5 due to 22 out of 72 dropped probes since last increase.
Increasing send delay for 192.168.0.51 from 5 to 10 due to 13 out of 41 dropped probes since last increase.
Increasing send delay for 192.168.0.1 from 10 to 20 due to 13 out of 41 dropped probes since last increase.
Increasing send delay for 192.168.0.1 from 20 to 40 due to 11 out of 22 dropped probes since last increase.
...
SF-Port5000-TCP:V=7.80%I=7%D=2/26%Time=5E56E93C%P=armv6-alpine-linux-musle
...
|     HTTP/1.0 200 OK
|     Date: Wed, 26 Feb 2020 21:55:08 GMT
|     Content-Length: 1890
...
|     Pragma: no-cache
|     X-Frame-Options: deny
|     Date: Wed, 26 Feb 2020 21:55:13 GMT
|     <!DOCTYPE html>
|     <html lang="en">
|     <head>
|     <script>
...
SF-Port80-TCP:V=7.80%I=7%D=2/26%Time=5E56E93C%P=armv6-alpine-linux-musleab
SF:ihf%r(GetRequest,7D8,"HTTP/1\.0\x20200\x20OK\r\nDate:\x20Wed,\x2026\x20
SF:Feb\x202020\x2021:55:08\x20GMT\r\nContent-Length:\x201890\r\nContent-Ty
...
SF:s,7D8,"HTTP/1\.0\x20200\x20OK\r\nDate:\x20Wed,\x2026\x20Feb\x202020\x20
...
==============NEXT SERVICE FINGERPRINT (SUBMIT INDIVIDUALLY)==============
SF-Port3000-TCP:V=7.80%I=7%D=2/26%Time=5E56E93C%P=armv6-alpine-linux-musle
...
SF:\nX-Frame-Options:\x20deny\r\nDate:\x20Wed,\x2026\x20Feb\x202020\x2021:
...
SF:rset=UTF-8\r\nExpires:\x20-1\r\nPragma:\x20no-cache\r\nX-Frame-Options:
SF:\x20deny\r\nDate:\x20Wed,\x2026\x20Feb\x202020\x2021:55:13\x20GMT\r\n\r
SF:\n<!DOCTYPE\x20html>\n<html\x20lang=\"en\">\n\x20\x20<head>\n\x20\x20\x
...
|     Content-Type: text/html
|     Content-Length: 64
|     Date: Thu, 01 Jan 1970 10:35:31 GMT
|     Last-Modified: Thu, 01 Jan 1970 00:00:19 GMT
|     Expires: Thu, 01 Jan 1970 10:40:31 GMT
...
|     Content-Type: text/html
|     Content-Length: 64
|     Date: Thu, 01 Jan 1970 10:35:25 GMT
|     Last-Modified: Thu, 01 Jan 1970 00:00:19 GMT
|     Expires: Thu, 01 Jan 1970 10:40:25 GMT
|     <meta http-equiv="refresh" content="0;url=http://belkin.range">
|   SIPOptions: 
|     HTTP/1.1 200 OK
|     Server: axhttpd/1.4.9
...
1 service unrecognized despite returning data. If you know the service/version, please submit the following fingerprint at https://nmap.org/cgi-bin/submit.cgi?new-service :
SF-Port5555-TCP:V=7.80%I=7%D=2/26%Time=5E56E946%P=armv6-alpine-linux-musle
SF:abihf%r(adbConnect,2C,"AUTH\x01\0\0\0\0\0\0\0\x14\0\0\x008\n\0\0\xbe\xa
SF:a\xab\xb7\xd8I_\xf2\xf9R\xe6Jr\xa7\x19\x9a\x9d\x13\xc4\x04Y\xb3\x06\xf5
SF:");
...
# Nmap done at Wed Feb 26 21:57:29 2020 -- 256 IP addresses (7 hosts up) scanned in 266.10 seconds
